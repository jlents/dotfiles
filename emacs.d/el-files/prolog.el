...
;;; Installation:
;;
;; Insert the following lines in your ~/.emacs (or _emacs in case
;; of Windows/DOS) to make Emacs use this mode when editing Prolog files:
;;
...
(defvar prolog-use-sicstus-sd nil
